...
public class CssXpathExamples {
    ...
    void cssXpathExamples(){
        ...
        // <input type="email" class="inputtext login_form_input_box" name="email" id="userEmail" data-testid="email">
        $("[data-testid=email]").setValue("1");
        $(by("data-testid", "email")).setValue("1");

        // <input type="email" class="inputtext login_form_input_box" name="email" id="userEmail">
        $("[id=email]").setValue("1");
        $("#email").setValue("1");
        ...
        // <div class="inputtext">
        //      <input type="email" class="login_form_input_box"></input>
        // </div>
        $(".inputtext .login_form_input_box").setValue("1");
        $(".inputtext").$(".login_form_input_box").setValue("1");
